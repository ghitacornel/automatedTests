...
public class ModelAccessEnforcementConventionTest {

    private final JavaClasses classes = Packages.allClassesWithoutTests;

    @Test
    public void deny() {
        noClasses().that().resideInAPackage(Packages.MODEL)
                .should().dependOnClassesThat().resideInAPackage(Packages.CONFIG)
